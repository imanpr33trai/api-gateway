...
describe('Responses Controller - Hono', () => {
  ...
  beforeAll(() => {
    ...
    app.post(
      '/v1/responses',
      responsesController.createResponse.bind(responsesController)
    )
  })
  ...
  test('should handle error gracefully', async () => {
    ...
    const errorController = new ResponsesController(
    ...
    errorApp.post(
      '/v1/responses',
      errorController.createResponse.bind(errorController)
    )

...
export const OutputItemTypeEnum = z.enum(["message", "function_call", "reasoning"]);
...
export const ResponsesRequestSchema = z.object({
    ...
    prompt: z
        .object({
            id: z.string(),
            variables: z.record(z.string(), z.union([z.string(), z.unknown()])).optional(),
...
export type ResponsesOutputContent = z.infer<typeof ResponsesOutputContentSchema>;
...
export type ResponsesStreamEventType = z.infer<typeof ResponsesStreamEventTypeEnum>;
